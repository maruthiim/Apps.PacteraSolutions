...
exports.childRoutes = [
    ...
    { path: 'administration', component: administration_component_1.AdministrationComponent, canActivate: [route_guard_service_1.RouteGuardService], data: { title: 'New Proposal', icon: 'glyphicon glyphicon-copy' } },
